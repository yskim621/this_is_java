...
public class PerformanceExample {
	...
	public static void main(String[] args) throws Exception {
		Path from = Paths.get("src/chap19_nio/sec03/exam01_direct_buffer/house.jpg");
		Path to1 = Paths.get("src/chap19_nio/sec03/exam01_direct_buffer/house2.jpg");
		Path to2 = Paths.get("src/chap19_nio/sec03/exam01_direct_buffer/house3.jpg");
